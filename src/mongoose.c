 ...
 *
 *  Also modified the directory listing html to match lighttpd server to be friendly towards
 *  other http clients which expects us to be a standard http server.
 *  Modification is on Line: 7972(Modified directory listing) , 7896 (Modified mg_print_dir_entry)
 */
